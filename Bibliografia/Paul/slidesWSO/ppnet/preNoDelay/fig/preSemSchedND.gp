...
plot 'data/str_sem' using ($1-300):($3<19 ? $3 : 1/0) notitle "" with points pt 1 lt -1 ,\
       'data/str_sem' using ($1-300):($3>19 ? 19 : 1/0) notitle "" with points pt 8 lt -1 ps 2
set output
set terminal pop
