...
plot 'data/str_sem' using 1:($2<95 ? $2 : 1/0) notitle "" with points pt 1 lt -1 ,\
       'data/str_sem' using 1:($2>95 ? 95 : 1/0) notitle "" with points pt 8 lt -1 ps 2
set output
set terminal pop
