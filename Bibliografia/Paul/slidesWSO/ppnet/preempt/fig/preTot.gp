...
plot 'data/str_tot_udp' using ($1-300):($2<190 ? $2 : 1/0) notitle "" with points pt 1 lt -1 ,\
       'data/str_tot_udp' using ($1-300):($2>190 ? 190 : 1/0) notitle "" with points pt 8 lt -1 ps 2
set output
set terminal pop
