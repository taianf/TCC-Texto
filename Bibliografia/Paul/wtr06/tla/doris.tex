...
% last modified on Tue Jan 04 00:16:20 PT 2005 by lamport
\begin{document}
\tlatex
...
\@xx{}%
\@x{ UpdateCounter ( id )\@s{20.31} \.{\defeq}}%
\@y{\@s{0}%
 The local counter \ensuremath{K[id]} is incremented by 1.
}%
\@xx{}%
\@x{ UpdateTimer ( t ,\, id )\@s{17.61} \.{\defeq}}%
\@y{\@s{0}%
 Reset \ensuremath{t[id]} to 0
}%
\@xx{}%
\@x{ UpdateGamma ( id )\@s{21.98} \.{\defeq}}%
\@y{\@s{0}%
 Update the \ensuremath{Gamma} tuple when receiving an elementary
}%
\@xx{}%
\@x{\@s{141.03}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ UpdateState ( id ,\, bool )\@s{8.75} \.{\defeq}}%
\@y{\@s{0}%
 Update the state variable to the value \ensuremath{bool
}}%
\@xx{}%
\@x{ ReceiveHardMsg ( id )\@s{14.37} \.{\defeq}}%
\@y{\@s{0}%
 Task \ensuremath{id} receives a slot message
}%
\@xx{}%
\@x{ ReceiveBestMsg ( id )\@s{17.08} \.{\defeq}}%
\@y{\@s{0}%
 Process \ensuremath{id} receives a best effort message
}%
\@xx{}%
\@x{ ReceiveStopMsg ( id )\@s{16.94} \.{\defeq}}%
\@y{\@s{0}%
 Process \ensuremath{id} receives a STOP effort message
}%
\@xx{}%
\@x{\@s{141.03}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{}\midbar\@xx{}%
 \@x{ Timeout ( id )\@s{49.2} \.{\defeq} \.{\land} esTimer [ id ] \.{=}
 Delta\_es}%
\@x{\@s{135.39} \.{\land} UpdateCounter ( id )}%
\@x{\@s{135.39} \.{\land} UpdateTimer ( esTimer ,\, id )}%
\par\vspace{8.0pt}%
 \@x{ ElementaryWindow ( id ) \.{\defeq} \.{\land} 0 \.{\leq} t [ id ] \.{<}
 d}%
\@x{\@s{143.98} \.{\land} {\IF} K [ id ] \.{=} id}%
\@x{\@s{157.31} \.{\THEN}}%
\@x{\@s{172.07} \.{\land} list \.{\defeq} {\IF} state}%
\@x{\@s{224.32} \.{\THEN}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{172.07} \.{\land} SendHardMsg ( id ,\, list )}%
\@x{\@s{157.31} \.{\ELSE}}%
\@x{\@s{172.07} \.{\land} ReceiveHardMsg ( id )}%
\@x{\@s{172.07} \.{\land} {\IF} elementary message arrives}%
\@x{\@s{185.40} \.{\THEN}}%
\@x{\@s{200.16} \.{\land} UpdateGamma ( id )}%
\@x{\@s{200.16} \.{\land} UpdateState ( id ,\, true )}%
\@x{\@s{185.40} \.{\ELSE} UpdateState ( id ,\, false )}%
\par\vspace{8.0pt}%
 \@x{ ReservationWindow ( id ) \.{\defeq} \.{\land} delta \.{+} d\@s{4.91}
 \.{\leq} t [ id ] \.{<} delta \.{+} 2 \.{*} d}%
\@x{\@s{145.48} \.{\land} {\IF} K [ id ] \.{=} Gamma [ id ]}%
\@x{\@s{158.81} \.{\THEN} SendHardMsg ( id )}%
\@x{\@s{158.81} \.{\ELSE} ReceiveHardMsg ( id )}%
\par\vspace{8.0pt}%
 \@x{ BestEffortWindow ( id )\@s{7.63} \.{\defeq} \.{\land} 2 \.{*} ( delta
 \.{+} d ) \.{<} t [ id ] \.{<} Delta\_es}%
\@x{\@s{145.48} \.{\land} {\IF} t [ id ] \.{<} 3 \.{*} delta}%
\@x{\@s{158.81} \.{\THEN} {\IF}}%
\@y{\@s{0}%
 the \ensuremath{MAC} is iddle
}%
\@xx{}%
\@x{\@s{196.38} \.{\THEN}}%
\@x{\@s{211.14} \.{\land} beTimer ( id ) \.{=} d}%
\@x{\@s{211.14} \.{\land} UpdateTimer ( beTimer ,\, id )}%
\@x{\@s{211.14} \.{\land} UpdateCounter ( id )}%
\@x{\@s{211.14} \.{\land} {\IF} K [ id ] \.{=} id}%
\@x{\@s{224.48} \.{\THEN} {\IF}}%
\@y{\@s{0}%
 Process \ensuremath{id} has ``data'' to transmit
}%
\@xx{}%
 \@x{\@s{262.05} \.{\THEN} {\IF} t [ id ] \.{-} sizeOf ( data ) \.{>} 3 \.{*}
 d}%
\@x{\@s{299.62} \.{\THEN} SendBestMsg ( id ,\, sizeOf ( data ) )}%
\@x{\@s{299.62} \.{\ELSE} SendStopMsg ( id ,\, id )}%
\@x{\@s{262.05} \.{\ELSE}}%
\@y{\@s{0}%
 do nothing (loop)
}%
...
\@x{\@s{196.38} \.{\ELSE}}%
\@x{\@s{211.14} \.{\land} UpdateTimer ( beTimer ,\, id )}%
\@x{\@s{211.14} \.{\land} ReceiveBestMsg ( id )}%
\@x{\@s{211.14} \.{\land}}%
\@y{\@s{0}%
 wait for \ensuremath{EOF} interrupt
}%
\@xx{}%
\@x{\@s{158.81} \.{\ELSE}}%
\@x{\@s{173.57} {\IF} K [ id ] \.{=} id}%
\@x{\@s{173.57} \.{\THEN} {\IF}}%
\@y{\@s{0}%
 Process \ensuremath{id} has ``data'' to transmit
}%
\@xx{}%
\@x{\@s{211.14} \.{\THEN} SendStopMsg ( id ,\, id )}%
\@x{\@s{211.14} \.{\ELSE} SendStopMsg ( id ,\, id \.{+} 1 )}%
\@x{\@s{173.57} \.{\ELSE}}%
\@x{\@s{188.33} \.{\land} ReceiveStopMsg ( id )}%
\@x{}\bottombar\@xx{}%
\end{document}
