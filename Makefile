...
taian: taian-tcc.dvi taian-tcc.pdf
...
upload: $(TARBALL) index.html taian-tcc.tex template-qual.tex template-msc.tex template-prop.tex template-phd.tex .htaccess
	rsync -avp $^ $(UPLOAD_TO)
